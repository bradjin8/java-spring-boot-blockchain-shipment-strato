...
/**
 * Reserved keywords for function state mutability
 */
public enum StateMutability {
  ...
  @JsonCreator
  public static StateMutability fromValue(String text) {
    for (StateMutability b : StateMutability.values()) {
