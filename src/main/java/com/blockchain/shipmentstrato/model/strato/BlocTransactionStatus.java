...
public enum BlocTransactionStatus {
  ...
  BlocTransactionStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static BlocTransactionStatus fromValue(String text) {
    for (BlocTransactionStatus b : BlocTransactionStatus.values()) {
