package com.blockchain.shipmentstrato.api;
...
import com.blockchain.shipmentstrato.api.auth.*;
import com.blockchain.shipmentstrato.api.auth.OAuth.AccessTokenListener;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-01-07T11:36:15.752447+08:00[Asia/Shanghai]")public class ApiClient {
  public interface Api {}

  protected ObjectMapper objectMapper;
  private String basePath = "https://stratodemo.blockapps.net";
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("strato_auth".equals(authName)) {
        auth = new OAuth(OAuthFlow.implicit, "https://keycloak.blockapps.net/auth/realms/public/protocol/openid-connect/auth", "", "");
      } else {
